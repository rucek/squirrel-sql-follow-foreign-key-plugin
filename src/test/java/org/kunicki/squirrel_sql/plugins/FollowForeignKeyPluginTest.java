 ...
 */
public class FollowForeignKeyPluginTest extends AbstractSessionPluginTest
{
	@Override
	protected IPlugin getPluginToTest() throws Exception
	{
		return new FollowForeignKeyPlugin();
	}
	...
	public void testSessionStarted() throws Exception
	{
		...
		((FollowForeignKeyPlugin) classUnderTest).sessionStarted(mockSession);
	}
